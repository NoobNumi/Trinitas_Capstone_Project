...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO seminar_reservation_record (user_id, first_name, last_name, street_add, city_municipality, province, postal_code, contact_no, guest_count, check_in, check_out, catering, price, payment_method) VALUES (:user_id,:first_name, :last_name, :street_add, :city_municipality, :province, :postal_code, :contact_no, :guest_count, :check_in, :check_out, :catering, :price, :payment_method)";
        ...
        <div class="row" id="reservation-row">
            <form action="" class="mx-auto" method="POST" id="reserve-n-appoint-form" enctype="multipart/form-data">
                ...
                <div class="col-md-6" id="services">
                    ...
                    <p class="text-center" id="form-title">Seminar</p>
                    <div class="row g-2">
                        <div class="col-6">
                    ...
                    (function updatePrice() {
                        ...
                        function calculatePrice() {
                            ...
                            if (isNaN(guestCount) || isNaN(days)) {
                                ...
                                var totalPrice = (guestCount * 800 * days) + (cateringPrice * guestCount * days);
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h6 class="text-center">Service Type: Seminar</h6>
                                <div class="row g-2">
                                    <div class="col">
                                        <a class="btn" id="next-btn" href="seminar_form.php">Cancel</a>
                                    </div>
                                    <div class="col">
