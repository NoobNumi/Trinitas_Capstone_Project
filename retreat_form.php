...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO retreat_reservation_record (user_id, first_name, last_name, street_add, city_municipality, province, postal_code, contact_no, guest_count, check_in, check_out, room_type, catering, price, payment_method) VALUES (:user_id,:first_name, :last_name, :street_add, :city_municipality, :province, :postal_code, :contact_no, :guest_count, :check_in, :check_out, :room_type, :catering, :price, :payment_method)";
        ...
        <div class="row" id="reservation-row">
            <form action="" class="mx-auto" method="POST" id="reserve-n-appoint-form" enctype="multipart/form-data">
                ...
                <div class="col-md-6" id="services">
                    ...
                    <p class="text-center" id="form-title">Recollection</p>
                    <div class="row g-2">
                        <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" id="guest-list">
                            <div class="form-floating" style="display: flex; margin-top: 10px;">
                                <div class="col">
                                    <p style="padding: 2px; float:left;">Guest/s</p>
                                </div>
                                <div class="col" id="guest-count-box">
                                    <i class="fa-solid fa-plus"></i>
                                    <input type="text" class="guest-count" name="guest_count" readonly value="0" style="border: none; width: 13px;margin-bottom: 6px;">
                    ...
                    <div class="col">
                        <div class="form-floating">
                            <select class="form-select room-type" id="floatingSelect" aria-label="Floating label select example" name="room_type" required>
                                <option value="Casa Maria">Casa Maria (With Aircon)</option>
                                <option value="Lunduyan">Lunduyan (Without Aircon)</option>
                                <option value="Attic">Attic (Without Aircon)</option>
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <button class="confirm-btn" type="submit" name="submit" data-bs-toggle="modal" data-bs-target="#myModal1">Ok</button>
                        </div>
                    </div>
                </div>
                <script>
                    (function incrementDecrementInput() {
                        ...
                        var input = document.querySelector("#guest-count-box > input");
                    ...
                    function updatePrice() {
                        var guestCountInput = document.querySelector("#guest-list .guest-count");
                        ...
                        var roomTypeSelect = document.querySelector(".form-select.room-type");

                        function calculatePrice() {
                            var guestCount = parseInt(guestCountInput.value);
                            ...
                            if (isNaN(guestCount) || isNaN(days)) {
                                priceElement.textContent = "₱ 0";
                                hiddenPriceInput.value = 0;
                            } else {
                                var totalPrice = (guestCount * roomTypePrice * days) + (cateringPrice * guestCount * days);
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h6 class="text-center">Service Type: Retreat</h6>
                                <div class="row g-2">
                                    <div class="col">
