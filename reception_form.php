...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO reception_reservation_record (user_id, first_name, last_name, street_add, city_municipality, province, postal_code, contact_no, check_in, check_out,  price, payment_method) VALUES (:user_id,:first_name, :last_name, :street_add, :city_municipality, :province, :postal_code, :contact_no, :check_in, :check_out, :price, :payment_method)";
        ...
        <div class="row" id="reservation-row">
            <form action="" class="mx-auto" method="POST" id="reserve-n-appoint-form" enctype="multipart/form-data">
                ...
                <div class="col-md-6" id="services">
                    ...
                    <p class="text-center" id="form-title">Reception</p>
                    <div class="row g-2">
                        <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <?php if (!isset($_SESSION['user_id'])) { ?>
                                <button class="confirm-btn" data-modal-target="modal1">Ok</button>
                            <?php } else { ?>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h6 class="text-center">Service Type: Reception</h6>
                                <div class="row g-2">
                                    <div class="col">
