...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO recollection_reservation_record (user_id, first_name, last_name, street_add, city_municipality, province, postal_code, contact_no, guest_count, check_in, check_out, catering, price, payment_method) VALUES (:user_id,:first_name, :last_name, :street_add, :city_municipality, :province, :postal_code, :contact_no, :guest_count, :check_in, :check_out, :catering, :price, :payment_method)";
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h6 class="text-center">Service Type: Recollection</h6>
                                <div class="row g-2">
                                    <div class="col">
